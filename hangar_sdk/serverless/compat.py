...
if os.name == "nt":
    ...
    def prevent_msvc_compiling_patch():  # type: ignore
        ...
        def raise_compile_error(*args, **kwargs):  # type: ignore
            raise CompileError("Hangar blocked C extension compiling.")
    ...
    _SETUPTOOLS_SHIM = (
        ...
        r"from hangar_sdk.serverless.compat import prevent_msvc_compiling_patch;"
    ...
    #  * Hangar creates a subprocess of `pip wheel ...` to build sdists
    #    into wheel files.
    ...
    # of the subprocess that Hangar starts. This replaces the
